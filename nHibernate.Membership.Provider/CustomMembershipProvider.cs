...
namespace Providers
{
    public sealed class CustomMembershipProvider : MembershipProvider
    {
        ...
        public override bool ChangePassword(string username, string oldPwd, string newPwd)
        {
            ...
            var cmd = new OdbcCommand("UPDATE [Tournament].WebsiteUsers " +
                                                  ...
                                                  out MembershipCreateStatus status)
        {
            ...
            if (u == null)
            {
                ...
                var conn = new OdbcConnection(connectionString);
                var cmd = new OdbcCommand("INSERT INTO [Tournament].WebsiteUsers " +
        ...
        {
            var conn = new OdbcConnection(connectionString);
            var cmd = new OdbcCommand("DELETE FROM [Tournament].WebsiteUsers " +
                                      " WHERE Username = ? AND Applicationname = ?", conn);
        ...
        {
            var conn = new OdbcConnection(connectionString);
            var cmd = new OdbcCommand("SELECT Count(*) FROM [Tournament].WebsiteUsers " +
        ...
        public override string GetPassword(string username, string answer)
        {
            ...
            var conn = new OdbcConnection(connectionString);
            var cmd = new OdbcCommand("SELECT Password, PasswordAnswer, IsLockedOut FROM [Tournament].WebsiteUsers " +
                                      " WHERE Username = ? AND ApplicationName = ?", conn);
        ...
        {
            var conn = new OdbcConnection(connectionString);
            var cmd = new OdbcCommand("SELECT PKID, Username, Email, PasswordQuestion," +
                                      " Comment, IsApproved, IsLockedOut, CreationDate, LastLoginDate," +
                                      " LastActivityDate, LastPasswordChangedDate, LastLockedOutDate" +
                                      " FROM [Tournament].WebsiteUsers WHERE Username = ? AND ApplicationName = ?", conn);
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    ...
                    if (userIsOnline)
                    {
                        var updateCmd = new OdbcCommand("UPDATE [Tournament].WebsiteUsers " +
        ...
        public override MembershipUser GetUser(object providerUserKey, bool userIsOnline)
        {
            ...
            var cmd = new OdbcCommand("SELECT PKID, Username, Email, PasswordQuestion," +
                                      " Comment, IsApproved, IsLockedOut, CreationDate, LastLoginDate," +
                                      " LastActivityDate, LastPasswordChangedDate, LastLockedOutDate" +
                                      " FROM [Tournament].WebsiteUsers WHERE PKID = ?", conn);
        ...
        {
            var conn = new OdbcConnection(connectionString);
            var cmd = new OdbcCommand("SELECT Username" +
                                      " FROM [Tournament].WebsiteUsers WHERE Email = ? AND ApplicationName = ?", conn);
        ...
        public override string ResetPassword(string username, string answer)
        {
            ...
            var conn = new OdbcConnection(connectionString);
            var cmd = new OdbcCommand("SELECT PasswordAnswer, IsLockedOut FROM [Tournament].WebsiteUsers " +
                                      " WHERE Username = ? AND ApplicationName = ?", conn);
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            var conn = new OdbcConnection(connectionString);
            var cmd = new OdbcCommand("SELECT Password, IsApproved FROM [Tournament].WebsiteUsers " +
                                      " WHERE Username = ? AND ApplicationName = ? AND IsLockedOut = 0", conn);
            ...
            try
            {
                ...
                if (CheckPassword(password, pwd))
                {
                    if (isApproved)
                    {
                        ...
                        var updateCmd = new OdbcCommand("UPDATE [Tournament].WebsiteUsers SET LastLoginDate = ?" +
                                                        " WHERE Username = ? AND ApplicationName = ?", conn);
        ...
        private void UpdateFailureCount(string username, string failureType)
        {
            ...
            try
            {
                ...
                if (failureCount == 0 || DateTime.Now > windowEnd)
                {
                    ...
                    if (failureType == "password")
                        cmd.CommandText = "UPDATE [Tournament].WebsiteUsers " +
